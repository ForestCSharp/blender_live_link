...
struct SmallStructs FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVector(small_structs()) &&
           verifier.EndTable();
  }
...
struct SmallStructsBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_small_structs(::flatbuffers::Offset<::flatbuffers::Vector<const JustSmallStruct *>> small_structs) {
...
inline ::flatbuffers::Offset<SmallStructs> CreateSmallStructsDirect(
  ...
  auto small_structs__ = small_structs ? _fbb.CreateVectorOfStructs<JustSmallStruct>(*small_structs) : 0;
...
inline bool operator==(const SmallStructsT &lhs, const SmallStructsT &rhs) {
  return
      (lhs.small_structs == rhs.small_structs);
}
...
inline void SmallStructs::UnPackTo(SmallStructsT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = small_structs(); if (_e) { _o->small_structs.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->small_structs[_i] = *_e->Get(_i); } } else { _o->small_structs.resize(0); } }
}
...
inline ::flatbuffers::Offset<SmallStructs> CreateSmallStructs(::flatbuffers::FlatBufferBuilder &_fbb, const SmallStructsT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _small_structs = _o->small_structs.size() ? _fbb.CreateVectorOfStructs(_o->small_structs) : 0;
  return CreateSmallStructs(
      _fbb,
      _small_structs);
}
