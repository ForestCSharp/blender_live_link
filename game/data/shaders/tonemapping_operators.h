...
const float GT7_LUT_RESOLUTION = float(TONEMAP_LUT_RESOLUTION);
const float GT7_LUT_INPUT_MAX = TONEMAP_LUT_INPUT_MAX;
const float ACES2_LUT_RESOLUTION = float(TONEMAP_LUT_RESOLUTION);
const float ACES2_LUT_INPUT_MAX = TONEMAP_LUT_INPUT_MAX;
const float ACES2_LUT_LAYER_OFFSET = float(TONEMAP_ACES2_LAYER_OFFSET);
const float AGX_LUT_RESOLUTION = float(TONEMAP_LUT_RESOLUTION);
const float AGX_LUT_INPUT_MAX = TONEMAP_LUT_INPUT_MAX;
const float AGX_LUT_LAYER_OFFSET = float(TONEMAP_AGX_LAYER_OFFSET);
